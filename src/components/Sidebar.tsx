...
export default function Sidebar({ currentScreen, onNavigate, onLogout, isOpen, onToggle }: SidebarProps) {
  const menuItems = [
          ...
          <div className={`bg-slate-50 rounded-2xl flex items-center gap-3 ${isOpen ? 'p-4 mb-4' : 'p-2 mb-4 justify-center'}`}>
            ...
            {isOpen && (
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-slate-900 truncate">Dmitry Marcelo</p>
