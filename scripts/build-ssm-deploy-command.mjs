...
const deployScript = [
  ...
  'docker compose run --rm certbot certonly --preferred-profile shortlived --webroot --webroot-path /var/www/certbot --non-interactive --agree-tos --cert-name "${APP_CERT_NAME}" "${CERTBOT_RENEW_ARGS[@]}" "${CERTBOT_CONTACT_ARGS[@]}" --ip-address "${APP_HOST}"',
